#!/bin/bash
#SBATCH --job-name=fvd_fake_no_text_c
...
python -m FVD.tools.inference_to_generate_fake_clips_balanced_dataset \
  ...
  --stride 10 \
  --base_out_dir /work/dlclarge2/alidemaa-text-control-orbis/orbis/FVD/pretrained_no_text_c/generated_data/rollout_runs \
  --collect_root /work/dlclarge2/alidemaa-text-control-orbis/orbis/FVD/pretrained_no_text_c/generated_data/fvd_fake_by_prompt \
  --job_tag pretrained_no_text_seed42 \
